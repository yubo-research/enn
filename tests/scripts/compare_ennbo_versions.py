...
_cspec = importlib.util.spec_from_file_location(
    "compare_ennbo_versions_common",
    Path(__file__).resolve().parent / "compare_ennbo_versions_common.py",
)
...
BenchmarkResult = _common.BenchmarkResult
apply_quick_overrides = _common.apply_quick_overrides
experiment_combos = _common.experiment_combos
run_benchmark = _common.run_benchmark
