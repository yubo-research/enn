//! In-RAM exhaustive search for small observation counts (N ≤ 1000).
...
pub const SMALL_N_INCORE_SEARCH_LIMIT: usize = 1000;
...
mod tests {
    ...
    #[test]
    fn small_n_incore_limit_is_1000() {
        assert_eq!(SMALL_N_INCORE_SEARCH_LIMIT, 1000);
    }
